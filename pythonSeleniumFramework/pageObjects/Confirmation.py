...
class ConfirmationPage:
    ...
    def getCountry(self):
        return self.driver.find_element(*ConfirmationPage.country)  #calling class variable by classname.variable_name -> * treats the particular variable as tuple & deserialises like below commented line
